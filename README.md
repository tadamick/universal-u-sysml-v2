...
This work is offered as a contribution to the former path. The reference model will be published as an open-source repository, structured for community extension, with a methodology companion that documents how public standards documentation translates to formal model elements. The intent, to use an aerospace analogy, is to provide higher education project managers and systems engineers something to build from — the specification for a future airport that future aircraft will eventually require.
